...
<STRING_STATE> {
    ...
    // Contenido válido del string (cualquier cosa menos ", \, o saltos de linea)
    ([^\"\\\n\r] | \\.)+ {
        stringBuilder.append(yytext());
    }

    // Salto de linea cierra el string con error
    [\n\r] {
...
<CHAR_STATE> {
    ...
    // Contenido válido del char (un solo caracter)
    [^\\'\n\r] {
        stringBuilder.append(yytext());
    }
    ...
    // Salto de linea cierra el char con error
    [\n\r] {
